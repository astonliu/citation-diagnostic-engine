...
from cde.refs import work_identity, biblio_match, unscoreable, decide
from cde.diagnose import reasons as rr
...
def test_terminal_scope_exclusion_reasons_do_not_drift():
    ...
    """
    from cde.diagnose import outcome as tox
...
def test_journal_authority_is_empty_and_inert():
    from cde.refs.journal_identity import JOURNAL_AUTHORITY, resolve_journal_id
...
def test_f2d_active_and_f2i_gated_off_in_current_config():
    from cde.refs.biblio_match import _F2D_STRICT_PREFIX_ENABLED
    from cde.refs.journal_identity import JOURNAL_AUTHORITY

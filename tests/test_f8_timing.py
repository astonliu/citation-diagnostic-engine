...
from cde.refs.doi_lookup import DOI_ANSWERED_ABSENT
from cde.refs.retraction import (F8_CLEAR, F8_QUALIFIED, F8_TIMING_INDETERMINATE,
                            F8_NOT_APPLICABLE, F8_UNRESOLVED, assess_f8_timing)
from cde.refs.schema import ClaimedRef, F8, Reference, UNSCOREABLE
...
def test_the_clearing_answer_is_not_retried():
    ...
    from cde.refs.retraction import F8_RETRYABLE_REASONS, assess_f8_timing_with_retry

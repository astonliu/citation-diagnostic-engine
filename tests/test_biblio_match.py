...
from cde.refs import biblio_rerank
...
from cde.refs.biblio_match import (match_score, best_match, field_agreement,
...
from cde.refs.lookup import compare_and_flag
...
def test_dead_pmid_still_flagged():
    ...
    ref = Reference("reg3", "", ClaimedRef(title="Anything at all", claimed_pmid="0"))
...
from cde.refs.biblio_match import _title_variants  # noqa: E402

...
from cde.diagnose import f5_seams as f5s
from cde.diagnose import pipeline as jr
from cde.refs.notice import NoticeStatus
...
def test_concurrent_gets_for_one_work_mint_exactly_one_packet():
    from cde.diagnose.evidence_store import F5EvidenceStore
...
def test_a_wired_screen_must_declare_thread_safety_too():
    from cde.diagnose import candidate_screen as fcs
...
def test_the_screen_counts_every_call_under_concurrency():
    from cde.diagnose import candidate_screen as fcs
    from cde.diagnose.supersession import CandidateWork

...
from cde.refs import biblio_match as bm
from cde.refs import confirm as cf
from cde.refs import decide as dc
from cde.refs import doi_lookup as dl
from cde.refs import lookup as lk
from cde.runtime import openalex_telemetry as tele
from cde.runtime import production_launcher as pl
from cde.runtime import ratelimit
from cde.refs import run as run_mod
...
def test_launch_full_threads_the_key_and_puts_the_tallies_in_the_manifest(
    ...
    f5s = importlib.import_module("cde.diagnose.f5_seams")
    f7s = importlib.import_module("cde.diagnose.f7_seams")
    monkeypatch.setattr(f5s, "validate_production_f5_configuration",
                        lambda **_k: None)
    monkeypatch.setattr(f7s, "validate_production_f7_configuration",
                        lambda **_k: None)

    band1 = importlib.import_module("cde.refs.run")

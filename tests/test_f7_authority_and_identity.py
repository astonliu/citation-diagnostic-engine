...
from cde.diagnose.entity import (
    HOLD_REASONS,
...
from cde.diagnose.engine import DiscriminatorContractError, EntityAssessment, EntityState
...
def test_an_empty_exclusion_list_leaves_every_existing_digest_unmoved():
    ...
    from cde.diagnose.entity import _evidence_context_sha256
    base = f7t.make_context()
...
def test_every_emitted_hold_reason_is_enumerated():
    ...
    from cde.diagnose import entity as f7_entity

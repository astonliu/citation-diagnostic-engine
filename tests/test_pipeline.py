...
runmod=importlib.import_module("cde.refs.run"); confmod=importlib.import_module("cde.refs.confirm")
...
assert callable(cde.refs.run_pipeline) and callable(cde.refs.decide.decide)

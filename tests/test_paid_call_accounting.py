...
from cde.claims.aggregate import make_coverage_judge
from cde.diagnose.entity import F7Policy
from cde.runtime.recording_adapter import PaidCallMeter, paid_call_meter
...
def test_the_ledger_and_the_receipt_are_deliberately_not_name_joinable():
    ...
    from cde.runtime.recording_adapter import RUN_SEAMS

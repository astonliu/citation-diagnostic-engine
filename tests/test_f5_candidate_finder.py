...
from cde.diagnose import candidate_finder as finder
from cde.diagnose import f5_seams
...
def test_f5_candidate_finder_is_in_both_runtime_provenance_boundaries():
    from cde.diagnose import pipeline as judgment_run
    from cde.runtime import production_launcher

    hashes = judgment_run._module_hashes(False, {}, None)
    assert "diagnose/candidate_finder.py" in hashes
    assert "diagnose/candidate_finder.py" in production_launcher.GOVERNING_MODULES

...
from cde.freeze import bootstrap, fixtures_v1 as fx, schema_gate
from cde.freeze.canon_v1 import CanonV1Error, canon_sha256, canon_v1
from cde.freeze.semantic_validator_v1 import (RULES, TrustedConstants,
                                                 pctencode, validate)
...
def test_sv041_negative_artifact_unreachable_from_ref(git_universe, tmp_path):
    ...
    from cde.freeze.semantic_validator_v1 import GitContext
...
def test_sv011_positive_indeterminate_extract_quarantined():
    ...
    from cde.freeze.semantic_validator_v1 import derive_disposition
...
def test_sv050_positive_development_mode_never_reportable(rel):
    from cde.freeze.semantic_validator_v1 import derive_reportability
...
def test_validate_returns_list_for_malformed_artifact_values(universe):
    ...
    from cde.freeze.semantic_validator_v1 import RULES as _rules
    for v in out:

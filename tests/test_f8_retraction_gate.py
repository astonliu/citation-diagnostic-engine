...
from cde.refs import ncbi_meta
from cde.diagnose import reasons as rr
from cde.refs import schema as S
from cde.refs.decide import decide
from cde.refs.preband_disposition import (DISPOSITION_LABELS, FAULT_LABELS,
                                        build_rows)
from cde.refs.run import process_reference, retraction_state
...
def test_decide_makes_no_network_call(monkeypatch):
    import cde.refs.decide as decide_mod
    import inspect
...
def test_retraction_word_is_still_stripped_from_titles():
    ...
    from cde.refs.biblio_match import normalize_title, _TITLE_PREFIX_RE

...
from cde.diagnose.candidate_screen import CandidateScreenBatch, CandidateScreenDecision
...
def test_validate_record_rejects_rehashed_neutral_as_confirmation():
    from cde.diagnose.controversy_bundle import build_controversy_bundle

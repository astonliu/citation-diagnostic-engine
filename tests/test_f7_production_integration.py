...
from cde.diagnose.entity import validate_f7_record
from cde.diagnose.f7_seams import make_production_f7_policy, make_production_f7_seams
...
def test_replay_rejects_rehashed_wrong_work_binding(tmp_path, monkeypatch):
    import copy
    from cde.diagnose.entity import record_sha256

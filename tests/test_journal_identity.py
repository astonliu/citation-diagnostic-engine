...
from cde.refs.journal_identity import (journal_identity, JournalAuthority,
                                     containment_only_census, M_EXACT_TEXT,
                                     M_CONTAINMENT, M_ISSN, M_AUTHORITY_ALIAS,
                                     M_MANUAL_ALIAS, M_AMBIGUOUS)
from cde.refs.biblio_match import field_agreement
...
# ==========================================================================
from cde.refs.journal_identity import resolve_journal_id  # noqa: E402

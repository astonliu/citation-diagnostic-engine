...
from cde.diagnose.evidence_store import (
...
from cde.diagnose.contradiction_prompt import render_comparability_source
from cde.diagnose.f5_seams import make_fetch_comparability_source
...
from cde.diagnose.evidence_store import SOURCE_PACKET_SCHEMA_VERSION

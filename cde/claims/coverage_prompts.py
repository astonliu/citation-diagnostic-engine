"""cde/claims/coverage_prompts.py -- the FULL-TEXT coverage prompt (``coverage_v3``).
...
from . import spans as ss
from ..runtime.anthropic_transport import CACHE_BREAK_MARKER
from ..runtime.recording_adapter import PaidCallMeter
from .aggregate import fulltext_judge_dict_v3, no_usable_fulltext_dict

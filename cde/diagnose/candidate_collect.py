...
Run:
    PYTHONPATH=. python -m cde.diagnose.candidate_collect --xml-dir <dir> \
...
from ..refs.ncbi_meta import (        # noqa: F401  (re-export)
...
# ==========================================================================
# 6. NCBI helpers -- MOVED to cde/refs/ncbi_meta.py (network, through the shared
...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="cde.diagnose.candidate_collect",

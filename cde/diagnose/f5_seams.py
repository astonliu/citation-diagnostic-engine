"""cde/diagnose/f5_seams.py -- the six injected callables F5 needs to run.
...
from . import contradiction_prompt as fcp
...
from ..refs.notice import make_notice_resolver
...
def validate_production_f5_configuration(*, seams, evidence_builder,
    ...
    from .supersession import F5Policy, validate_f5_policy
...
def build_pubmed_f5_runtime(*, complete, as_of_date: str, api_key: str = "",
    ...
    """
    from .candidate_finder import PubMedCandidateFinder

"""cde/diagnose/contradiction_prompt.py -- the F5 contradiction judge's prompt.
...
from ..claims import spans as ss
from ..runtime.anthropic_transport import CACHE_BREAK_MARKER as _CACHE_BREAK_MARKER

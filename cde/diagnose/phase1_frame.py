...
#     python -m cde.diagnose.phase1_frame --xml-dir <random_oa_pool> \\
#         --out-dir <data> --email you@example.org

#     # with LLM S2 refinement, the harness/notebook injects a classifier:
#     from cde.diagnose.phase1_frame import screen_dir
...
#         prog="cde.diagnose.phase1_frame",

...
from ..diagnose.candidate_finder import RANKING_DEFAULT, RANKINGS
...
def build_production_f5(*, as_of_date: str, model: str, email: str,
    ...
    from ..diagnose.candidate_screen import (CANDIDATE_SCREEN_PROMPT_VERSION,
                                      make_candidate_screen)
    from ..diagnose.f5_seams import (CANDIDATE_CAP, build_f5_seams,

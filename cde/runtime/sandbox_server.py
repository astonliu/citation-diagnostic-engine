...
Usage:
    python -m cde.runtime.sandbox_server
    python -m cde.runtime.sandbox_server --authorities /path/to/f7_authorities
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(
        prog="cde.runtime.sandbox_server",
    ...
    if not Path("cde").is_dir():
        print("[sandbox-server] run this from the repository root; "

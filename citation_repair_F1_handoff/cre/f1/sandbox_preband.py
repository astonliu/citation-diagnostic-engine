...
Usage:
    python -m cre.f1.sandbox_preband packet.json
    python -m cre.f1.sandbox_preband packet.json --dry-run
"""
...
from . import run as band1
from .preband_contract import CITATION_ID_RE
...
from .unscoreable import is_non_article_reference

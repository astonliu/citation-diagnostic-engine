...
from cre.f1.biblio_match import VERDICT_WRONG_PAPER, flag_verdict
from cre.f1.schema import ClaimedRef, RetrievedRecord
from cre.f1.work_identity import _series_conflict
...
def test_C2_structural_corruption_is_implausible(name):
    from cre.f1.biblio_match import _implausible_author
...
def test_C2_filtered_to_empty_yields_None_never_False():
    ...
    from cre.f1.biblio_match import match_score
...
def test_C3_editorial_suffix_is_stripped(raw, clean):
    ...
    from cre.f1.biblio_match import _canonical_pages
...
def test_C4_uninverts_only_on_an_exact_surname_and_initials_match():
    from cre.f1.biblio_match import _uninvert_corporate

...
:mod:`cre.f1.check_openai_judge`, which needs a key and is not run by pytest.
"""
from __future__ import annotations

import pytest

from . import completer, model_pricing, openai_transport as ot
from .anthropic_transport import CACHE_BREAK_MARKER
from .recording_adapter import NOT_COLLECTED, TokenLedger, merge_token_ledgers
...
def test_both_providers_are_handed_the_same_bytes_for_the_same_prompt():
    from .anthropic_transport import split_cache_blocks
    prompt = _marked()

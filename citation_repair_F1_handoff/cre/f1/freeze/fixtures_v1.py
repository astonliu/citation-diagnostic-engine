...
from cre.f1.freeze import schema_gate
from cre.f1.freeze.canon_v1 import canon_sha256
...
OID = "sha1:" + "0" * 40
FIXTURES_DIR = (pathlib.Path(__file__).resolve().parents[1]
                / "fixtures" / "freeze")
...
def build_module_manifest():
    modules = []
    from cre.f1.freeze.bootstrap import TRUST_BOUNDARY_ROLES
